...
routes.get('/listartarefas', TarefasController.getAll);//Rota responsavel por trazer todas as tarefas
...
routes.post('/criartarefa', TarefasController.store);//Rota responsavel por gravar as tarefas no banco de dados
